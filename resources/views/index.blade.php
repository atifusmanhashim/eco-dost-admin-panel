        ...
        $('.complaints-row').click(function(e){
            ...
            $.ajax({
                ...
                success:function(response)
                {
                    ...
                    $('#complaint_comments').append(complaint_comments);
...
<div>
    <div class="dashboard-page">
        ...
        <div class="cards-outer-div">
            <div class="cards-inner">
                <div class="dashboard-card">
                    <p class="card-heading"> {{ $complaint_status->total_complaints }}</p>
                    <p class="card-text">Complaints</p>
                </div>
            </div>
            <div class="cards-inner">
                <div class="dashboard-card">
                    <p class="card-heading">{{ $complaint_status->total_pending_complaints }}</p>
                    <p class="card-text">Pending</p>
                </div>
            </div>
            <div class="cards-inner">
                <div class="dashboard-card">
                    <p class="card-heading">{{ $complaint_status->total_inprocess_complaints }}</p>
                    <p class="card-text">In Process</p>
                </div>
            </div>
            <div class="cards-inner">
                <div class="dashboard-card">
                    <p class="card-heading">{{ $complaint_status->total_resolved_complaints }}</p>
                    <p class="card-text">Resolved</p>
                </div>
            </div>
            <div class="cards-inner">
                <div class="dashboard-card">
                    <p class="card-heading">{{ $complaint_status->total_cancelled_complaints }}</p>
        ...
        <div class="parallel-heading-div">
            ...
            <div class="tabs-btn-div">
                ...
                <button onclick="window.location.href='{{url('/complaints')}}'">See All</button>
            </div>
        </div>
        <div class="table-responsive table-div">
            <table class="table" id="table_data">
                ...
                <tbody>
                    <tr data-id="{{ $itm['complaint_id'] }}" class="complaints-row" data-bs-toggle="modal"
                        data-bs-target="#complainDetailModal" style="cursor:pointer;">
                        <td>{{ $count }}</td>
