...
<div class="section-background">
    <div class="form-outer-div">
        <div class="logo-div"> <img src="{{url('images/EcoDost Logo_New-login.svg')}}" /> </div>
        <p class="form-heading">Hello User</p>
        <p class="form-text">
            Login to Continue
            @if($errors->any())
            <br><br>
        ...
        <div class="form-div">
            <form action="{{ url('postlogin') }}" method="POST" id="login_frm" name="login_frm" autocomplete="off">
                ...
                <div class="input-outer-div">
                    @csrf
                    <div class="label-div"><label>Email ID/Phone No.</label></div>
                    <div class="input-div">
                        <input type="email" class="form-control @error('email') is-invalid @enderror" value=""
                            id="email_input" placeholder="Email" name="email" type="text" />
                        @error('email')
                ...
                <div class="button-div">
                    <button id="login_btn" type="submit" name="login_btn">Sign In</button>
